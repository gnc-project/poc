...
func (proof *ChiaProof) Verify(useless, challenge [32]byte, filter bool) error {
	if proof.pos == nil {
...
func (proof *ChiaProof) VerifiedQuality(useless, challenge [32]byte, filter bool, slot, height uint64) (*big.Int, error) {
...
func HashValChia(chiaQuality []byte, slot, height uint64) [32]byte {
...
func Q1FactorChia(k uint8) *big.Float {
	...
	return a.Mul(a, big.NewFloat(QualityConstantGNC*QualityConstantGNCValidity))
}
